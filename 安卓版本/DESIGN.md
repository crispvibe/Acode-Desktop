...
- iOS 设计 Token：`iOS版本/Codevoke/Views/VisualStyle.swift`
- iOS 聊天顶部栏与输入栏：`iOS版本/Codevoke/Views/ChatView.swift`、`iOS版本/Codevoke/Views/InputBarView.swift`
- iOS 侧栏：`iOS版本/Codevoke/Views/RootView.swift`、`iOS版本/Codevoke/Views/SidebarView.swift`
- iOS 远程设备与设置：`iOS版本/Codevoke/Views/DeviceListView.swift`、`iOS版本/Codevoke/Views/SettingsView.swift`
- 截图基准：`设计图/Android-Compose-设计基准/screenshots`
- Android 当前落点：`安卓版本/app/src/main/java/com/codevoke/android/ui/theme`、`安卓版本/app/src/main/java/com/codevoke/android/ui/components`
